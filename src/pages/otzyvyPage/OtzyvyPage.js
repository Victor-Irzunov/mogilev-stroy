					...
					<div className='border-b py-4'>
						<div className='flex'>
							...
							<div className='ml-3 w-1/2'>
								...
								<p className='text-xs mb-1'>Забор и ворота под ключ</p>
						...
						<div className='pl-6 mt-2'>
							<p className='text-left text-sm mt-4'>
								Сделали красивый забор, как я мечтала. Я сразу поняла, что строители опытные, подсказали, где купить материалы подешевле, привезли всё, установили. Ценой и качеством я довольна. Вы молодцы. Спасибо!
							</p>
